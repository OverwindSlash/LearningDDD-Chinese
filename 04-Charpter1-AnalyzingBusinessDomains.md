...
将核心子域的实施工作外包也是不明智的。它是一项战略投资。在核心子域上偷工减料不仅在短期内有风险，而且从长远来看也会产生致命的后果：例如，导致一个无法支撑公司目标的且难以维护的代码库。应该指派组织中最具技术力的人才从事核心子域的工作。此外，在内部实现核心子域可以使公司能更快地改变和演进解决方案，从而在更短的时间内建立竞争优势。
